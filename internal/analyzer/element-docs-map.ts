export const docsToElementMapping = {
  'button.md': [
  ...
  'progress.md': ['progress/linear-progress.ts', 'progress/circular-progress.ts'],
  ...
  'text-field.md': ['textfield/filled-text-field.ts', 'textfield/outlined-text-field.ts'],
};
